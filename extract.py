...
def main():
    ...
    params = [
        {'table_title': 'PD Comm Manager', 'title': "'Division Manager'", 'other_fields': 'name = "Mc Donald,Joey L"',
         'table_color': 'blue'},
        ...
        {'table_title': 'Fire Seniors', 'title': "'Supervg Pub Safety Disp'", 'other_fields': 'dept = "Fire"',
         'table_color': 'red'},
        {'table_title': 'PD Seniors', 'title': "'Supervg Pub Safety Disp'", 'other_fields': 'dept = "Police"',
         'table_color': 'blue'},
        {'table_title': 'All Seniors', 'title': "'Supervg Pub Safety Disp'", 'other_fields': '1',
         'table_color': 'grey'},
